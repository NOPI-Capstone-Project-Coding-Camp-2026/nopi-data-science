...
| Data Primer       | Foto struk asli hasil dokumentasi mandiri                    | 117 gambar         |
| CORD-v2           | Dataset publik struk dari NAVER CLOVA AI                     | ±1.000 gambar      |
| Dataset Non-Struk | Kumpulan gambar non-struk dari Kaggle untuk kelas pembanding | 1.002 gambar final |

> Dataset gambar primer tersedia untuk anggota tim. Hubungi Tim Data Science NOPI untuk akses.
> CORD-v2 tersedia secara publik di [Hugging Face](https://huggingface.co/datasets/naver-clova-ix/cord-v2).
> Repository resmi CORD dari NAVER CLOVA AI tersedia di [GitHub](https://github.com/clovaai/cord).

### Sumber Dataset Non-Struk

Dataset non-struk dikumpulkan dari beberapa dataset publik Kaggle berikut:
...
| Movie Posters        | https://www.kaggle.com/datasets/phiitm/movie-posters              |
...
| `OCR_Metrics.csv`                     | Data metrik evaluasi OCR berupa nilai CER dan WER per gambar struk |

---

## 📊 Dashboard Streamlit

Dashboard Streamlit digunakan untuk menampilkan hasil analisis Business Question secara visual, meliputi evaluasi performa OCR, estimasi laba, dan laporan transaksi.

🔗 Streamlit App: https://nopi-nota-pintar-ai-ayfncrtwwx4uarikp2eqx4.streamlit.app/
...
* NAVER CLOVA AI. **CORD-v2 Dataset**. [Hugging Face](https://huggingface.co/datasets/naver-clova-ix/cord-v2)
* Arnaud58. **Landscape Pictures**. [Kaggle](https://www.kaggle.com/datasets/arnaud58/landscape-pictures)
* Sayangoswami. **Reddit Memes Dataset**. [Kaggle](https://www.kaggle.com/datasets/sayangoswami/reddit-memes-dataset)
* Phiitm. **Movie Posters**. [Kaggle](https://www.kaggle.com/datasets/phiitm/movie-posters)
* Alessio Corrado. **Animals10**. [Kaggle](https://www.kaggle.com/datasets/alessiocorrado99/animals10)
